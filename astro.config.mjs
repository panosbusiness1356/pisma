...
const DEV_PAGES = ['nea-arxiki', 'neo', 'dokimes-hero', 'dokimes-kartes', 'dokimes-chat', 'dokimes-stil', 'dokimes-aesthetic', 'dokimes-skini', 'dokimes-kapnos', 'dokimes-pisma-efe', 'dokimes-intro', 'dokimes-pisma-hover', 'dokimes-loading'];
const devPages = {
