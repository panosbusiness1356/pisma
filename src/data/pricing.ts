...
export const CATEGORIES: PricingCategory[] = [
  {
    ...
    // Η συνδρομή της πλατφόρμας δεν είναι δική μας χρέωση (χρήστρια 12/09/2026), γι' αυτό σημείωση και όχι επιλογή.
    note: 'E-shop σε Shopify: η συνδρομή της πλατφόρμας πληρώνεται από εσάς απευθείας στο Shopify. Ο λογαριασμός και το κατάστημα ανήκουν στην επιχείρησή σας.',
    mode: 'radio',
    options: [
